...
To get more information about the data and how the webpage is created see the [explainer notebook](https://github.com/michelle95n/MovieRecommendation/blob/master/Explainer_Notebook.ipynb). 

...
To get more information about the data and how the webpage is created see the [explainer notebook](https://mybinder.org/v2/gh/michelle95n/MovieRecommendation/10ef442e7f8e3e30377dacc01eb0d8720c69ab76). When the repository loads, press the file 'Explainer_Notebook' and wait for the notebook to show.
 If the link does not work, then [here](https://github.com/michelle95n/MovieRecommendation/blob/master/Explainer_Notebook.ipynb) is a direct link to the explainer notebook in the GitHub repository, since nbviewer time after time gave multiple errors. 
